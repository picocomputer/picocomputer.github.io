...
Extended RAM (XRAM) is R/W memory that is accessed with the two XRAM portals provided by the :doc:`ria`. There is 64KB of shared XRAM.

Extended registers (XREG) are set with an :doc:`api` call. The standard VGA module is PIX ID 1.
