...
The design philosophy for the VGA system is to enable the full power of the Pi Pico while maintaining some 8-bit purity. 6502 programmers should be solving problems with the same thought prcesses as was used for classic 8-bit home computers. To that end, the VGA system is limited to working from 64K of extended memory (XRAM).
